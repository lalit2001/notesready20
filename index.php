...
<head>
    <title>NotesReady</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="NotesReady - Online learning platform">
...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
    ...
    <header class="bg-gradient" id="home">
        <div class="container mt-5">
            <h1>We give the Best Courses
            </br> the Web</h1>
            <p class="tagline">In this modern digitalized world, we give the best online notes to the graduation students for their bright future. Best Of Luck !!! </p>
        </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="card-title">B.A</h4>
                                    <p class="card-text">Study the paper of Arts. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="card-text">Study the paper of commerce. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card features">
                        <div class="card-body">
                            <div class="media">
                                <span class="ti-book gradient-fill ti-3x mr-3"></span>
                                <div class="media-body">
                                    <h4 class="card-title">B.sc</h4>
                                    <p class="card-text">Study the paper of Science.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-6">
                    ...
                    <h2>Over 50 Courses
                        from 3 Streams</h2>
                    <p class="mb-4">There was a moment to read from the books. But the time has come to get the
                         knowledge with frame and name from this web. Across all over the India faculty are ready
                          to share their valuable notes which is helpful to the students. Basically Bsc students
                           of three streams i.e Science, Arts & Commerce will get the notes in web and also doubt 
                           clearing session direct with the favourite lectures. </p>
    ...
    <div class="section light-bg">
        <div class="container">
            <div class="section-title">
                ...
                <h3>Do more with our Website</h3>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div>
                        ...
                        <h2>This is Why
                            We have Solid Idea</h2>
                        <p class="mb-4">There is a moment in the life of any aspiring student that it is time to gain that first knowledge. It’s exciting to think about setting up your own viewing station. In the life of any aspiring student that it is time to buy that first knowledge. It’s exciting to think about setting up your own destination.</p>
        ...
        <div class="container">
            ...
            <div class="testimonials owl-carousel">
                <div class="testimonials-single">
                    ...
                    <blockquote class="blockquote">My main motive is to guide the students for their bright future. I always with my loveble students. Get the notes which is valuable for the higher examination.</blockquote>
                ...
                <div class="testimonials-single">
                    ...
                    <p class="text-primary">The lead of the programming team at NotesReady</p>
                    <small>He is a die-hard coder,and technology geek</small>
                </div>
                <div class="testimonials-single">
                    ...
                    <p class="text-primary">Technology Manager of NotesReady</p>
                    <small>He is a die-hard coder,and technology geek</small>
                </div>
                <div class="testimonials-single">
                    ...
                    <p class="text-primary">Developer of NotesReady</p>
                    <small>He is a die-hard coder,and technology geek</small>
                </div>
                <div class="testimonials-single">
                    ...
                    <p class="text-primary"> of NotesReady</p>
        ...
        <div class="modal-dialog modal-login">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="http://notesready.com/Register_cntrl/insertdata" method="post" id="" enctype="multipart/form-data">                                        <div class="form-group">
                        <label class="sr-only" for="">Full Name</label>
                        <input type="text" name="fname" required="required" placeholder="Enter Your Full Name..." class="form-first-name form-control" id="form-first-name">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="">User Name</label>
                        <input type="text" name="username" required="required" placeholder="User Name..." class="form-last-name form-control" id="form-last-name">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="f">Password</label>
                        <input type="password" name="password" required="required" placeholder="Password" class="form-last-name form-control" id="form-last-name">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="">Phone</label>
                        <input type="text" pattern="[1-9]{1}[0-9]{9}" maxlength="10" name="phone" required="required" placeholder="Phone Number" class="form-last-name form-control" id="form-last-name">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="">Email</label>
                        <input type="email" name="email" required="required" placeholder="Email..." class="form-email form-control" id="form-email"><span id="msg"> </span>
                    </div>
                  <div class="form-group">
                        <label class="sr-only" for="">Branch</label>
                        <input type="text" name="branch" required="required" placeholder="Branch" class="form-last-name form-control" id="form-last-name">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="">College</label>
                        <input type="text" name="college" required="required" placeholder="College Name..." class="form-last-name form-control" id="form-last-name">
                    </div>
                    <div class="">
                        <input type="file" name="pimage" placeholder="Profile Image" class=" form-control1" id="form-last-name"><span class="text1"> Upload Profile Image</span>
                    </div>

           <input type="submit" class="btn1 btn btn-primary" value="Sign me up!" onblur="check_if_exists()" style="
           padding: 10px;font-size: 20px;border: 1px solid;color: white;">
                    <input type="reset" value="Clear Form" class=" btn1 btn btn-danger" style="
           padding: 10px;font-size: 20px;border: 1px solid;">
                </form>
                </div>
				...
				<div class="col-lg-4 d-flex flex-column address-wrap">
					<div class="single-contact-address d-flex flex-row">
						...
						<div class="contact-details">
							<h5>GIET GHANGAPATNA</h5>
							<p>
								NEAR ROTI GOTHAPATNA 
								MALIPADA ,752054
							</p>
						</div>
					</div>
					<div class="single-contact-address d-flex flex-row">
						...
						<div class="contact-details">
							<h5>+91-891736050,+91-7008419745</h5>
